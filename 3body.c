...
//    printf("s01=%f, s02=%f, s12=%f\n", s01, s02, s12);
    ...
    double s0102 = s01/s02;
    double s0112 = s01/s12;
    double s0212 = s02/s12;

    if(s0102<1) s0102=1.0/s0102;
    if(s0112<1) s0112=1.0/s0112;
    if(s0212<1) s0212=1.0/s0212;

//    printf("s0102=%f, s0112=%f, s0212=%f\n", s0102, s0112, s0212);

    if(s0102 > BOUNDARY_C || s0112 > BOUNDARY_C || s0212 > BOUNDARY_C ){
        dump();
        reset();
    }
}
